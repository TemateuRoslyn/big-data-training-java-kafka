...
public class MaesOneConsumer {
     ...
     */
    public MaesOneConsumer(String groupId, String serverHost, String topic_name){
    ...
    public void streamConsumer(){
        Executors.newScheduledThreadPool(1).scheduleAtFixedRate(()->{
             ...
             consumerRecords.forEach(cr -> {
                System.out.println("Consumer Maes 1: Received message =>  {\t key => " + cr.key() + ", " + cr.value() + " => " + cr.offset() + "\t}");
             });
